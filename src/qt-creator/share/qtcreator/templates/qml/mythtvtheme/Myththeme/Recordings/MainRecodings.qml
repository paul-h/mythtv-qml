        ...
        Flickable{
            ...
            Column{
                ...
                MythButton{
                 ...
                 Keys.onEnterPressed: {
                    ...
                    onButtonClick: {
                        ...
                        settingsPageLoader.source = "Guide.qml"
                    }
                }
                ...
                MythButton{
                    ...
                    onButtonClick: {
                    settingsPageLoader.opacity = 1
                    settingsPageLoader.source = "RecordingRules.qml"
                }
                }
                MythButton{
                    id: infoCenter
                    ...
                    onButtonClick: {
                    settingsPageLoader.opacity = 1
                    settingsPageLoader.source = "UpandCommingRecordings.qml"
                }
                }
                MythButton{
                    id: cds
                    ...
                    onButtonClick: {
                    settingsPageLoader.opacity = 1
                    settingsPageLoader.source = "PRecored.qml"
                }
                }
                MythButton{
                    id:watchTV
...
//    }
    Text {
        ...
        anchors{
            ...
            bottomMargin: mediaLibRoot.height / 20
            right: parent.right
            rightMargin: 12
        }
    }
