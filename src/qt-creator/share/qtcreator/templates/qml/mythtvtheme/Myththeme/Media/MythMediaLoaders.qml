        ...
        MythMediaLibMenu{
            ...
            Column{
                ...
                MythButton{
                    ...
                    namepxSize: 24
                    color: "grey"
                    onButtonClick: mediaLibLoader.source  = "MythThemeGridView.qml"
                }
                MythButton{
                    //                    anchors.centerIn: settings
                    height: Screen.height / 20
                    ...
                    namepxSize: 24
                    color: "grey"
                    onButtonClick: mediaLibLoader.source  = "MythThemeCoverFlow.qml"
                }
